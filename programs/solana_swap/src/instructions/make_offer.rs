use crate::{constants::ANCHOR_DISCRIMINATOR, transfer_tokens, Offer};
...
pub fn send_offered_tokens_to_vault(
    ...
    msg!("Send offered tokens to vault LOGIC TRIGGER");
    let from = &ctx.accounts.maker_token_account_a;
    let to = &ctx.accounts.vault;
    let amount = &token_a_offered_amount;
